...
RSTRING_H = rstring.h $(RTYPESTYPES_H)
...
RDYNARRAY_H = rdynarray.h $(RALLOCATOR_H) $(RERROR_H)
RLIST_H = rlist.h $(RERROR_H) $(RTYPESTYPES_H) $(RNODE_H)
...
RRESOURCE_H = rresource.h $(RTYPESTYPES_H)

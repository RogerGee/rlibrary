...
namespace rtypes
{
    ...
    public:
        ...
        {// set the desired capacity and set the string length to the desired capacity (this is the default expected behavior)
    ...
    template<class CharType>
    bool operator ==(const rtype_string<CharType>& s1,const rtype_string<CharType>& s2)
    {
        if (s1.size()==s2.size())
        {
    ...
    template<class CharType>
    bool operator ==(const rtype_string<CharType>& s1,const CharType* s2)
    {
        dword len = 0;
        while (s2[len])
            len++;
    ...
    template<class CharType>
    bool operator ==(const CharType* s1,const rtype_string<CharType>& s2)
    {
        dword len = 0;
        while (s1[len])
            len++;
    ...
    template<class CharType>
    const rtype_string<CharType> operator +(rtype_string<CharType> left,const rtype_string<CharType>& right)
    {
        left += right;
        return left;
    }
    ...
    template<class CharType>
    const rtype_string<CharType> operator +(rtype_string<CharType> left,const CharType* right)
    {
        left += right;
        return left;
    }
    ...
    template<class CharType>
    const rtype_string<CharType> operator +(const CharType* left,const rtype_string<CharType>& right)
    {

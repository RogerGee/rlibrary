...
# (rlibrary)
OBJ_files = $(addprefix $(OBJDIR)/,rstream.o rstringstream.o rlasterr.o rfilename.o riodevice.o) $(UTILITY_OBJ_files) $(INTEGRATION_OBJ_files)
...
# [sys]
$(OBJDIR)/rfilename.o: rfilename.cpp rfilename_posix.cpp $(RFILENAME_H)
	$(BUILD_OBJ) $(OBJ_OUT)rfilename.o rfilename.cpp -D RLIBRARY_BUILD_POSIX

# [sys]
$(OBJDIR)/riodevice.o: riodevice.cpp riodevice_posix.cpp $(RIODEVICE_H)
